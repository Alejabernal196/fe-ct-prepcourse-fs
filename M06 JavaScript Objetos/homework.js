...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var nuevoObjeto = {nombre: nombre, edad: edad, meow: function () {
      return 'Meow!';
   }};
return nuevoObjeto;
...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   // Retornar el arreglo.
   // Tu código:
   // ex: let objetoMuchosUsuarios = [{esPremium}, {esPremium}, {esPremium}]
   //                                  0             1           2
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   // ex: var objetoUsuario = {posts : [{ likes: 10}, {likes:10}, {likes: 10} ]}
   let total = 0;
